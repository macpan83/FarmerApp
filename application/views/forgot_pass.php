  ...
  <div class="container-fluid mb-5">
    <div class="row ml-3 mr-3 mb-5" id="reg_form">
      ...
      <div class="col-md-4 offset-md-4 rounded bg-dark" id="reg_form_child">
        ...
        <div class="row">
          <h1 class="card card-body bg-dark font-weight-bold">Forgot password</h1>
        ...
        <div class="row">
          <div class="col-md-12">
            <button type="submit" name="sbmt" value="login" class="btn btn-primary pull-right mt-2 mb-2">Change password</button>
          </div>
        </div>
