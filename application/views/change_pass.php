        ...
        <div class="container-fluid">
          ...
          <div class="row">
              <div class="col-md-6 offset-md-3">
                  <div class="col-md-12">
                      <b class="text-success" style="font-size: 30px">Change password</b>
                  </div><br/><br/>
                  <?php
                    $attributes = array(
                        'class' => 'form', 
                  ...
                  <!--<form method="post" name="" action="">-->
                    ...
                    <input type="hidden" name="email" value="<?=$this->session->userdata('email')?>" />
                      ...
                      <div class="form-group">
                          <label class="lead text-dark">Old password</label>
                          <input type="text" name="old_pass" class="form-control" value="" placeholder="Old password" />
                      </div>
                      <div class="form-group">
                          <label class="lead text-dark">New password</label>
                          <input type="text" name="new_pass" class="form-control" value="" placeholder="New password" />
                      </div>
                      <div class="form-group">
                          <label class="lead text-dark">Confirm New password</label>
                          <input type="text" name="con_new_pass" class="form-control" value="" placeholder="Confirm New password" />
                      </div>
                      <div class="form-group" align="right">
                          <input type="submit" name="sbmt" class="btn btn-outline-success" value="Change password" />
