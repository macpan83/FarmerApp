...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3 style="background: #4c6a49;margin-bottom: 53px;color: #fff; padding: 10px; border-radius: 5px;">
            ...
            <?php if(!empty($gallery['images'])){ ?>
                ...
                <?php foreach($gallery['images'] as $imgRow){ ?>
                    <div class="img-box col-md-3" id="imgb_<?php echo $imgRow['id']; ?>">
                        <img src="<?php echo base_url('uploads/product-images/'.$imgRow['file_name']); ?>" style="width: 250px;height:240px">
 ...
 <a style="margin-top:50px; float:right" href="<?php echo base_url('manage_gallery'); ?>" class="btn btn-primary">Back to List</a>
    </div>
