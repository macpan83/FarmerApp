...
?>
<html>
<head>Receipt of Purchase - <?php  echo $orderItemResult[0]["order_invoice"]; ?>
</head>
<body>
<div style="text-align:right;">
        <b>Sender:</b> Farmer App
    </div>
    <div style="text-align: left;border-top:1px solid #000;">
        <div style="font-size: 24px;color: #666;">INVOICE</div>
    </div>
<table style="line-height: 1.5;">
    <tr><td><b>Invoice:</b> #<?php echo $orderItemResult[0]["order_invoice"]; ?>
        </td>
        <td style="text-align:right;"><b>Receiver:</b></td>
    </tr>
    <tr>
        <td><b>Order Date:</b> <?php echo $orderedDate; ?></td>
        <td style="text-align:right;"><?php echo $result[0]["name"] ; ?></td>
    </tr>
    <tr>
        <td><b>Delivery Date:</b><?php echo $due_date; ?>
        </td>
        <td style="text-align:right;"><?php echo $result[0]["cname"]; ?></td>
    </tr>
<tr>
<td></td>
...
foreach ($orderItemResult as $k => $v) {
 ...
 //   $productResult = $productModel->getProduct($orderItemResult[$k]["product_id"]);
    ?>
    <tr> <td style="border:1px solid #cccccc;"><?php echo $orderItemResult[$k]["product_title"]; ?></td>
