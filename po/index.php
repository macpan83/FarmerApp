...
<body>
    <div class="phppot-container">
		...
		<?php foreach ($orderResult as $k => $v) { ?>
			<tr>
                    <td><?php echo $orderResult[$k]["oid"];?></td>
                    <td class="text-right"><?php echo $orderResult[$k]["tot_price"];?></td>
                    <td class="text-right"><?php echo $orderResult[$k]["status"];?></td>
                    <td class="text-right"><a target="_blank"
                        title="Generate Invoice"
                        href="./invoice.php?id=<?php echo $orderResult[$k]["ord_no"];?>"><?php echo $orderResult[$k]["ord_no"];?></a></td>
                </tr>
			<?php }?>
		</tbody>
        </table>
